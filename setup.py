...
setup(
    ...
    packages=['venv.lib.python3.6.distutils', 'venv.lib.python3.6.encodings', 'venv.lib.python3.6.importlib',
              ...
              'venv.lib.python3.6.site-packages.PyQt5.uic.Compiler', 'venv.lib.python3.6.site-packages.qtgui',
              'venv.lib.python3.6.site-packages.wheel', 'venv.lib.python3.6.site-packages.wheel.tool',
              'venv.lib.python3.6.site-packages.wheel.signatures', 'venv.lib.python3.6.site-packages.osc4py3',
              'venv.lib.python3.6.site-packages.osc4py3.demos', 'venv.lib.python3.6.site-packages.osc4py3.tests',
